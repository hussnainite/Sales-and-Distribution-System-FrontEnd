<template>
  <div class="sticky top-0 z-40">
    <div
      class="w-full h-20 px-6 bg-gradient-to-r from-yellow-400  to-green-500  border-b flex items-center justify-between"
    >
      <!-- left navbar -->
      <div class="flex">
        <!-- mobile hamburger -->
    ...
    >
      <a class="block px-4 py-2 hover:bg-gray-200"
        ><router-link to="/login">Logout</router-link></a
      >
    </div>
    <!-- dropdown menu end -->
  </div>
